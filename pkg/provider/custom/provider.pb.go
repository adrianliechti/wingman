...
const file_provider_proto_rawDesc = "" +
	...
	"\x05delta\x18\x05 \x01(\v2\x11.provider.MessageH\x00R\x05delta\x88\x01\x01\x120\n" +
	"\amessage\x18\x06 \x01(\v2\x11.provider.MessageH\x01R\amessage\x88\x01\x01\x12*\n" +
	"\x05usage\x18\a \x01(\v2\x0f.provider.UsageH\x02R\x05usage\x88\x01\x01B\b\n" +
	"\x06_deltaB\n" +
	"\n" +
	"\b_messageB\b\n" +
	"\x06_usage\"J\n" +
	...
	"\acontent\x18\x02 \x03(\v2\x11.provider.ContentR\acontent\"\xed\x01\n" +
	"\aContent\x12\x17\n" +
	"\x04text\x18\x01 \x01(\tH\x00R\x04text\x88\x01\x01\x12'\n" +
	"\x04file\x18\x03 \x01(\v2\x0e.provider.FileH\x01R\x04file\x88\x01\x01\x124\n" +
	"\ttool_call\x18\x04 \x01(\v2\x12.provider.ToolCallH\x02R\btoolCall\x88\x01\x01\x12:\n" +
	"\vtool_result\x18\x05 \x01(\v2\x14.provider.ToolResultH\x03R\n" +
